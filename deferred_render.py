...
class DeferredRenderer(DirectObject):
    ...
    def __init__(self, filter_setup=None, shading_setup=None, shadows=None, scene_mask=1, light_mask=2):
        ...
        # extension
        self.f = 'shader/{}_f.glsl'
        self.v = 'shader/{}_v.glsl'
        ...
        self.cube_tex=loader.load_cube_map('texture/cube/sky_#.png')
    ...
    def reset_filters(self, filter_setup, shading_setup=None, **kwargs):
        """
    ...
    def add_cone_light(self, color, pos=(0, 0, 0), hpr=(0, 0, 0),exponent=40,
        ...
        model = loader.load_model("model/cone")
    ...
    def add_point_light(self, color, model="model/sphere", pos=(0, 0, 0), radius=1.0, shadow_size=0):
        """
...
class ConeLight(object):
    ...
    def set_fov(self, fov):
        ...
        self.geom.remove_node()
        xy_scale = math.tan(deg2Rad(fov * 0.5))
        self.geom = loader.load_model("model/cone")
